...
glm::vec3 spotlightP(0.0f, 0.0f, 0.0f);
glm::vec3 spotlightD(0.0f, 0.0f, 0.0f);
bool active;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.diffuse"), 0.80f, 0.80f, 0.80f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].position"), 0.0f,0.0f,5.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].position"), 0.0f, 0.0f, -5.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].position"), 5.0f, 0.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].position"), -5.0f, 0.0f, 0.0f);
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.18f, -5.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
